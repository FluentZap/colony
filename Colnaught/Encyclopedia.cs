...
namespace Colnaught
{
    ...
    class Encyclopedia
    {
        ...
        public Encyclopedia()
        {
            ...
            Dictionaryof_BuildItems.Add(Listof_Structures.CityCenter, new Typeof_BuildItems() { BuildingType = Listof_BuildTypes.Structure, Texture = Listof_Texture.CityCenter });
            ...
            Dictionaryof_BuildItems.Add(Listof_Structures.RoadDirt, new Typeof_BuildItems() { BuildingType = Listof_BuildTypes.Zone, Texture = Listof_Texture.Road });
